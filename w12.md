...
커스텀 애노테이션 프로세서를 만들기 위해서는 아래처럼 Processor 또는 AbstractProcessor를 상속받아야 한다. <br/>
<pre>
...
위 프로세서를 등록하기 위해 먼저 컴파일한 후, 
resource/META-INF/services 디렉토리에
Processor의 패키지인 javax.annotation.processing.Processor 파일을 생성하고
내가 만든 프로세서의 패키지명을 작성한다. 
mvn install하여 jar파일로 만든다. 
<br/><br/><br/><br/>
