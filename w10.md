...
가능하면 메서드 전체에 lock을 거는 것보다 synchronized 블럭으로 임계영역을 최소화하는 것이 좋다.<br/>
<a href="https://github.com/gtpe/java-study/blob/master/src/main/java/w10/thread/ATM.java">ATM.java</a>
