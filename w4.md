...
## switch
switch문으로도 조건에 따라 실행할 실행문을 분기시킬 수 있다. 
switch문은 byte, short, char, int와 같은 프리미티브 타입들,
이늄 타입, String과 몇몇 프리미티브 타입의 래퍼 클래스(Character, Byte, Short, Integer)를 사용할 수 있다. 
<pre>
int month = 8;
String monthString;
